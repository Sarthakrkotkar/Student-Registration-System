...
public class MarkS extends JInternalFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == jb1) {
            MCA frm = new MCA(regn,"First Semester marks",1);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jb2) {
            MCA frm = new MCA(regn,"Second Semester marks",2);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jb3) {
            MCA frm = new MCA(regn,"Third Semester marks",3);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jb4) {
            MCA frm = new MCA(regn,"Forth Semester marks",4);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        /*if (e.getSource() == jb5) {
            MCA frm = new MCA(regn,"Fifth Semester marks",5);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jb6) {
            MCA frm = new MCA(regn,"Sixth Semester marks",6);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }*/
        if (e.getSource() == jbc) {
