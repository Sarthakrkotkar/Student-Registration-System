...
public class MarkT extends JInternalFrame implements ActionListener {
    ...
    public MarkT(String reg) {
        super("MARKS OF MBA BATCH",false,true,false,true);
        regno = reg;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == jb1) {
            MBA ps = new MBA(regno,"First Semester marks",1);
            frmAdminMDI.desktop.add(ps);
            ps.setVisible(true);
        }
        if (e.getSource() == jb2) {
            MBA ps = new MBA(regno,"Second Semester marks",2);
            frmAdminMDI.desktop.add(ps);
            ps.setVisible(true);
        }
        if (e.getSource() == jb3) {
            MBA ps = new MBA(regno,"Third Semester marks",3);
            frmAdminMDI.desktop.add(ps);
            ps.setVisible(true);
        }
        if (e.getSource() == jb4) {
            MBA ps = new MBA(regno,"Fourth Semester marks",4);
            frmAdminMDI.desktop.add(ps);
            ps.setVisible(true);
        }
        /*if (e.getSource() == jb5) {
            MBA ps = new MBA(regno,"Fifth Semester marks",5);
            frmAdminMDI.desktop.add(ps);
            ps.setVisible(true);
        }*/
        if (e.getSource() == jbc) {
